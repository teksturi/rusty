...
pub fn visit_statement<T: AnnotationMap>(validator: &mut Validator, statement: &AstStatement, context: &ValidationContext<T>) {
    match statement {
...
fn compare_function_exists<T: AnnotationMap>(type_name: &str, operator: &Operator, context: &ValidationContext<T>) -> bool {
...
/// statement
fn validate_type_nature<T: AnnotationMap>(validator: &mut Validator, statement: &AstStatement, context: &ValidationContext<T>) {
