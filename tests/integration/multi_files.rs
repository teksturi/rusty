use inkwell::{targets::{Target, InitializationConfig}, context::Context};
use rusty::{FilePath, diagnostics::Diagnostician, OptimizationLevel, DebugLevel, compile_module, runner::run_no_param};
