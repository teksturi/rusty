...
fn test_external_function_called() {
    ...
    module.add_global_mapping("times_two__INT", times_two_int as usize);
    module.add_global_mapping("times_two__REAL", times_two_real as usize);
...
fn test_generic_function_with_param_by_ref_called() {
    ...
    module.add_global_mapping("LEFT_EXT__STRING", left_ext__string as usize);
